...
abstract class $LabelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int labelId, String name, String? comment});
}
...
class _$LabelImpl implements _Label {
  const _$LabelImpl({required this.labelId, required this.name, this.comment});
  ...
  @override
  String toString() {
    return 'Label(labelId: $labelId, name: $name, comment: $comment)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, labelId, name, comment);

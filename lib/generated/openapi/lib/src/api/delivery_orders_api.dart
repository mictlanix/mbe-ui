...
class DeliveryOrdersApi {
  ...
  addDeliveryOrderLineApiV1DeliveryOrdersDeliveryOrderIdLinesPost({
    ...
    required DeliveryOrderLineRequest deliveryOrderLineRequest,
    ...
    final _path = r'/api/v1/delivery-orders/{delivery_order_id}/lines'
        .replaceAll(
          '{'
          r'delivery_order_id'
          '}',
    ...
    try {
      const _type = FullType(DeliveryOrderLineRequest);

...
class PointsOfSaleApi {
  ...
  Future<Response<PointSaleResponse>> createPointOfSaleApiV1PointsOfSalePost({ 
    ...
    PointSaleResponse? _responseData;
    ...
    return Response<PointSaleResponse>(
      data: _responseData,
  ...
  Future<Response<ListResponsePointSaleResponse>> listPointsOfSaleApiV1PointsOfSaleGet({ 
    ...
    ListResponsePointSaleResponse? _responseData;
    ...
    return Response<ListResponsePointSaleResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,

...
class ProductionSitesApi {
  ...
  Future<Response<ProductionSiteResponse>> createProductionSiteApiV1ProductionSitesPost({ 
    ...
    ProductionSiteResponse? _responseData;
    ...
    return Response<ProductionSiteResponse>(
      data: _responseData,
  ...
  Future<Response<ListResponseProductionSiteResponse>> listProductionSitesApiV1ProductionSitesGet({ 
    ...
    ListResponseProductionSiteResponse? _responseData;
    ...
    return Response<ListResponseProductionSiteResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,

...
class SalesOrdersApi {
  ...
  const SalesOrdersApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [SalesOrderResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SalesOrderResponse>>
  addSalesOrderLineApiV1SalesOrdersSalesOrderIdLinesPost({
    required int salesOrderId,
    required SalesOrderLineCreate salesOrderLineCreate,
    ...
    final _path = r'/api/v1/sales-orders/{sales_order_id}/lines'.replaceAll(
      '{'
      r'sales_order_id'
      '}',
    ...
    try {
      const _type = FullType(SalesOrderLineCreate);
    ...
    SalesOrderResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
                  rawResponse,
                  specifiedType: const FullType(SalesOrderResponse),
                )
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SalesOrderResponse>>
  cancelSalesOrderApiV1SalesOrdersSalesOrderIdCancelPost({
    required int salesOrderId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/sales-orders/{sales_order_id}/cancel'.replaceAll(
      '{'
      r'sales_order_id'
      '}',
      encodeQueryParameter(
  ...
  confirmSalesOrderApiV1SalesOrdersSalesOrderIdConfirmPost({
    ...
    final _path = r'/api/v1/sales-orders/{sales_order_id}/confirm'.replaceAll(
      '{'
      r'sales_order_id'
      '}',
      encodeQueryParameter(
  ...
  /// Returns a [Future] containing a [Response] with a [SalesOrderResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SalesOrderResponse>> createSalesOrderApiV1SalesOrdersPost({
    required SalesOrderCreate salesOrderCreate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/sales-orders';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
    ...
    try {
      const _type = FullType(SalesOrderCreate);
      _bodyData = _serializers.serialize(
        salesOrderCreate,
        specifiedType: _type,
      );
  ...
  getSalesOrderApiV1SalesOrdersSalesOrderIdGet({
    ...
    final _path = r'/api/v1/sales-orders/{sales_order_id}'.replaceAll(
      '{'
      r'sales_order_id'
      '}',
      encodeQueryParameter(
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ListResponseSalesOrderSummary] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ListResponseSalesOrderSummary>>
  listSalesOrdersApiV1SalesOrdersGet({
    bool? mine = false,
    int? customer,
    int? salesperson,
    String? status,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (salesperson != null)
        r'salesperson': encodeQueryParameter(
          _serializers,
          salesperson,
          const FullType(int),
        ),
    ...
    ListResponseSalesOrderSummary? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
                  rawResponse,
                  specifiedType: const FullType(ListResponseSalesOrderSummary),
                )
                as ListResponseSalesOrderSummary;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<ListResponseSalesOrderSummary>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<ProductLookupResponse>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<ProductLookupResponse>>>
  lookupProductsApiV1SalesOrdersProductLookupGet({
    ...
    final _path = r'/api/v1/sales-orders/product-lookup';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
    ...
    final _queryParameters = <String, dynamic>{
      r'pattern': encodeQueryParameter(
        _serializers,
        pattern,
        const FullType(String),
      ),
    ...
    BuiltList<ProductLookupResponse>? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
                  rawResponse,
                  specifiedType: const FullType(BuiltList, [
                    FullType(ProductLookupResponse),
                  ]),
                )
                as BuiltList<ProductLookupResponse>;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<BuiltList<ProductLookupResponse>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  removeSalesOrderLineApiV1SalesOrdersSalesOrderIdLinesLineIdDelete({
    ...
    final _path = r'/api/v1/sales-orders/{sales_order_id}/lines/{line_id}'
        .replaceAll(
          '{'
          r'sales_order_id'
          '}',
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SalesOrderResponse>>
  updateSalesOrderApiV1SalesOrdersSalesOrderIdPut({
    required int salesOrderId,
    required SalesOrderUpdate salesOrderUpdate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(SalesOrderUpdate);
      _bodyData = _serializers.serialize(
        salesOrderUpdate,
        specifiedType: _type,
      );
  ...
  updateSalesOrderLineApiV1SalesOrdersSalesOrderIdLinesLineIdPut({
    required int salesOrderId,
    required int lineId,
    required SalesOrderLineUpdate salesOrderLineUpdate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(SalesOrderLineUpdate);
      _bodyData = _serializers.serialize(
        salesOrderLineUpdate,
        specifiedType: _type,
      );

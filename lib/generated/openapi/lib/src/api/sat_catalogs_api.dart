...
class SatCatalogsApi {
  ...
  Future<Response<SatCatalogResponse>> getCfdiUsagesApiV1SatCfdiUsagesIdGet({ 
    ...
    SatCatalogResponse? _responseData;
    ...
    return Response<SatCatalogResponse>(
      data: _responseData,
  ...
  Future<Response<ListResponseSatCatalogResponse>> listCfdiUsagesApiV1SatCfdiUsagesGet({ 
    ...
    ListResponseSatCatalogResponse? _responseData;
    ...
    return Response<ListResponseSatCatalogResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,

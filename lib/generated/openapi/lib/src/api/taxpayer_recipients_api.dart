...
class TaxpayerRecipientsApi {
  ...
  createTaxpayerRecipientApiV1TaxpayerRecipientsPost({
    ...
    TaxpayerRecipientResponse? _responseData;
    ...
    return Response<TaxpayerRecipientResponse>(
      data: _responseData,
  ...
  listTaxpayerRecipientsApiV1TaxpayerRecipientsGet({
    ...
    ListResponseTaxpayerRecipientResponse? _responseData;
    ...
    return Response<ListResponseTaxpayerRecipientResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,

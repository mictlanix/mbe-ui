...
class VehicleOperatorsApi {
  ...
  createVehicleOperatorApiV1VehicleOperatorsPost({
    ...
    VehicleOperatorResponse? _responseData;
    ...
    return Response<VehicleOperatorResponse>(
      data: _responseData,
  ...
  listVehicleOperatorsApiV1VehicleOperatorsGet({
    ...
    ListResponseVehicleOperatorResponse? _responseData;
    ...
    return Response<ListResponseVehicleOperatorResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,

...
/// HighProfitMargin
@BuiltValue()
abstract class HighProfitMargin implements Built<HighProfitMargin, HighProfitMarginBuilder> {
  /// Any Of [String], [num]
  AnyOf get anyOf;

  HighProfitMargin._();

  factory HighProfitMargin([void updates(HighProfitMarginBuilder b)]) = _$HighProfitMargin;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(HighProfitMarginBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<HighProfitMargin> get serializer => _$HighProfitMarginSerializer();
}

class _$HighProfitMarginSerializer implements PrimitiveSerializer<HighProfitMargin> {
  @override

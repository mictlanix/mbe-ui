...
/// * [total]
@BuiltValue()
abstract class ListResponseCustomerListItem
    implements
        Built<
          ListResponseCustomerListItem,
          ListResponseCustomerListItemBuilder
        > {
  ...
  factory ListResponseCustomerListItem([
    void updates(ListResponseCustomerListItemBuilder b),
  ]) = _$ListResponseCustomerListItem;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ListResponseCustomerListItemBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ListResponseCustomerListItem> get serializer =>
      _$ListResponseCustomerListItemSerializer();
}

class _$ListResponseCustomerListItemSerializer
    implements PrimitiveSerializer<ListResponseCustomerListItem> {
  @override

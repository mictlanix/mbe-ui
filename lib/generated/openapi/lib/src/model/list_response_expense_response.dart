...
/// * [total]
@BuiltValue()
abstract class ListResponseExpenseResponse
    implements
        Built<ListResponseExpenseResponse, ListResponseExpenseResponseBuilder> {
  ...
  factory ListResponseExpenseResponse([
    void updates(ListResponseExpenseResponseBuilder b),
  ]) = _$ListResponseExpenseResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ListResponseExpenseResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ListResponseExpenseResponse> get serializer =>
      _$ListResponseExpenseResponseSerializer();
}

class _$ListResponseExpenseResponseSerializer
    implements PrimitiveSerializer<ListResponseExpenseResponse> {
  @override

...
/// * [total]
@BuiltValue()
abstract class ListResponseStoreResponse
    implements
        Built<ListResponseStoreResponse, ListResponseStoreResponseBuilder> {
  ...
  factory ListResponseStoreResponse([
    void updates(ListResponseStoreResponseBuilder b),
  ]) = _$ListResponseStoreResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ListResponseStoreResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ListResponseStoreResponse> get serializer =>
      _$ListResponseStoreResponseSerializer();
}

class _$ListResponseStoreResponseSerializer
    implements PrimitiveSerializer<ListResponseStoreResponse> {
  @override

...
/// * [total] 
@BuiltValue()
abstract class ListResponseSupplierResponse implements Built<ListResponseSupplierResponse, ListResponseSupplierResponseBuilder> {
  ...
  factory ListResponseSupplierResponse([void updates(ListResponseSupplierResponseBuilder b)]) = _$ListResponseSupplierResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ListResponseSupplierResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ListResponseSupplierResponse> get serializer => _$ListResponseSupplierResponseSerializer();
}

class _$ListResponseSupplierResponseSerializer implements PrimitiveSerializer<ListResponseSupplierResponse> {
  @override
  final Iterable<Type> types = const [ListResponseSupplierResponse, _$ListResponseSupplierResponse];

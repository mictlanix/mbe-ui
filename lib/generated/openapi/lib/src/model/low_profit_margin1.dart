...
/// LowProfitMargin1
@Deprecated('LowProfitMargin1 has been deprecated')
@BuiltValue()
abstract class LowProfitMargin1
    implements Built<LowProfitMargin1, LowProfitMargin1Builder> {
  /// Any Of [String], [num]
  AnyOf get anyOf;

  LowProfitMargin1._();

  factory LowProfitMargin1([void updates(LowProfitMargin1Builder b)]) =
      _$LowProfitMargin1;
  ...
  static Serializer<LowProfitMargin1> get serializer =>
      _$LowProfitMargin1Serializer();
}

class _$LowProfitMargin1Serializer
    implements PrimitiveSerializer<LowProfitMargin1> {
  @override

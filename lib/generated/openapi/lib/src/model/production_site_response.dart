...
/// * [disabled] 
@BuiltValue()
abstract class ProductionSiteResponse implements Built<ProductionSiteResponse, ProductionSiteResponseBuilder> {
  ...
  factory ProductionSiteResponse([void updates(ProductionSiteResponseBuilder b)]) = _$ProductionSiteResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ProductionSiteResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ProductionSiteResponse> get serializer => _$ProductionSiteResponseSerializer();
}

class _$ProductionSiteResponseSerializer implements PrimitiveSerializer<ProductionSiteResponse> {
  @override
  final Iterable<Type> types = const [ProductionSiteResponse, _$ProductionSiteResponse];

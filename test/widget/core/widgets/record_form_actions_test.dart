...
void main() {
  group(
    'RecordFormActions (017-ui-consistency-filters contracts/record-form-actions.md §7)',
    () {
      testWidgets('create mode with Save privileged: renders Save only', (
        tester,
      ) async {
        var saved = false;
        await _pump(
      ...
      testWidgets('create mode without Save privilege: renders nothing', (
        tester,
      ) async {
        await _pump(
          tester,
      ...
      testWidgets('view mode with update privilege: renders Edit only', (
        tester,
      ) async {
      ...
      testWidgets('view mode without update privilege: renders no Edit', (
        tester,
      ) async {
        await _pump(
          tester,
      ...
      testWidgets(
        'edit mode with update+delete privilege: renders Delete then Save, in that order',
        (tester) async {
          await _pump(
            tester,
            RecordFormActions(
      ...
      testWidgets('edit mode without delete privilege: renders Save only', (
        tester,
      ) async {
        await _pump(
          tester,
      ...
      testWidgets('delete invokes its callback only after confirmation', (
        tester,
      ) async {
        var deleted = false;
        await _pump(
      ...
      testWidgets(
        ...
        (tester) async {
          ...
          final saveWidth = tester
              .getSize(find.widgetWithText(FilledButton, 'Save'))
              .width;
